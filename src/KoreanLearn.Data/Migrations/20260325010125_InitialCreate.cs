        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Korean = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Chinese = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Romanization = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PdfUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PdfFileName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlashcardLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Korean = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Romanization = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Chinese = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    StandardAudioUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PronunciationExercises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PronunciationExercises_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PronunciationAttempts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PronunciationAttempts_PronunciationExercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "PronunciationExercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashcardLogs_NextReviewDate",
                table: "FlashcardLogs",
                column: "NextReviewDate");

            migrationBuilder.CreateIndex(
                name: "IX_FlashcardLogs_UserId_FlashcardId",
                table: "FlashcardLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PronunciationExercises_LessonId",
