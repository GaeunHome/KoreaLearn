    ...
    ILogger<HomeController> logger) : BaseController
{
    ...
    {
        logger.LogInformation("載入首頁 | UserId={UserId}", GetCurrentUserId());
    ...
    {
        logger.LogInformation("瀏覽隱私權頁面 | UserId={UserId}", GetCurrentUserId());
        return View();
    }
    ...
    public IActionResult Error()
    {
        ...
        logger.LogError("錯誤頁面被觸發 | RequestId={RequestId} | UserId={UserId}", requestId, GetCurrentUserId());
