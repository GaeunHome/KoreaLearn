...
- [x] **P3-03** 訂閱制方案（訂閱後解鎖所有課程）
- [x] **P3-04** 討論區（發文 + 回覆 + 軟刪除）
- [x] **P3-05** 學生儀表板（我的課程、進度百分比）
- [x] **P3-06** 證書產生（QuestPDF + 完課條件檢查）
- [x] **P3-07** 後台儀表板（課程數、訂單數、總收入、最近訂單）
- [x] **P3-08** 背景服務（每日檢查訂閱到期 + 字卡複習統計）
